...
do
    ...
    if not okRun then
        error("Minho Hub: Obsidian UI library runtime error: " .. tostring(result), 0)
    end
    if type(result) ~= "table" then
        error("Minho Hub: Obsidian UI library returned " .. type(result) .. " instead of a Library table", 0)
    end
