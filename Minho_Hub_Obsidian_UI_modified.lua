    ...
    function Funcs:AddKeyPicker(Idx, Info)
        ...
        do
            ...
            function KeybindsToggle:SetNormal(Normal)
                ...
                Checkbox.Visible = Library.IsMobile and not Normal
            end
        ...
        function KeyPicker:Update()
            ...
            if KeybindsToggle.Loaded then
                local MobileToggle = Library.IsMobile and KeyPicker.Mode == "Toggle"

                KeybindsToggle:SetNormal(not MobileToggle)
...
function Library:CreateWindow(WindowInfo)
    ...
    do
        Library.KeybindFrame, Library.KeybindContainer = Library:AddDraggableMenu(Library.IsMobile and "Keys" or "Keybinds")
