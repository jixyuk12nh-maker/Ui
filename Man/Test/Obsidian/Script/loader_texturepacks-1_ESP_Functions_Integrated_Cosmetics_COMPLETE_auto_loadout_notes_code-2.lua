...
local unobtainableFolder = weaponsFolder:FindFirstChild("Unobtainable")
local weaponList = {}
...
local function getDefaultWeapon(name)
    if table.find(weaponList, name) then
        return name
    end
    return weaponList[1]
end

local Mode = getDefaultWeapon("Assault Rifle")
local Mode2 = getDefaultWeapon("Handgun")
local Mode3 = getDefaultWeapon("Fists")
local Mode4 = getDefaultWeapon("Grenade")

local function pickLoadout()
    if not Mode or not Mode2 or not Mode3 or not Mode4 then
        return
    end
...
AutoLoadoutBox:AddDropdown("AutoLoadoutPrimary", {
    Text = "Primary",
    Values = weaponList,
    Default = Mode,
    Multi = false,
...
AutoLoadoutBox:AddDropdown("AutoLoadoutSecondary", {
    Text = "Secondary",
    Values = weaponList,
    Default = Mode2,
    Multi = false,
...
AutoLoadoutBox:AddDropdown("AutoLoadoutMelee", {
    Text = "Melee",
    Values = weaponList,
    Default = Mode3,
    Multi = false,
...
AutoLoadoutBox:AddDropdown("AutoLoadoutUtility", {
    Text = "Utility",
    Values = weaponList,
    Default = Mode4,
    Multi = false,
