...
local function SecretAttachStart()
    ...
    if SecretAttachRagebot.SilentAim
        ...
        and hookmetamethod and getnamecallmethod then
        ...
        hookFn = function(self, ...)
            ...
            if not SecretAttachRagebot.Enabled
                ...
                or (checkcaller and checkcaller()) then
                return prev(self, ...)
            end
...
local function SecretAttachStop()
    ...
    if type(SecretAttachRagebot.NamecallHook) == "function"
        and type(restorefunction) == "function" then
        pcall(restorefunction, SecretAttachRagebot.NamecallHook)
    end
