...
-- Spoofer UI Layout (Placeholder Only)
-- Functions are intentionally not connected yet.
local SpooferMainBox = Spoofer:AddGroupbox({ Name = "Spoofer Settings", Side = 1 })

SpooferMainBox:AddToggle("SpooferEnabled", {
    Text = "Enabled",
    Default = false,
    Callback = function(v)
    end,
...
SpooferMainBox:AddButton("Spoofer Feature 1", function()
end)

SpooferMainBox:AddButton("Spoofer Feature 2", function()
end)

local SpooferExtraBox = Spoofer:AddGroupbox({ Name = "Advanced Spoofer", Side = 2 })

SpooferExtraBox:AddDropdown("SpooferSelect", {
    Text = "Select Option",
    Values = { "None" },
    Default = "None",
    Multi = false,
...
SpooferExtraBox:AddInput("SpooferInput", {
    Text = "Input",
    Default = "",
    Finished = true,
})
