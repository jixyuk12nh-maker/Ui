...
-- ====================== TEXTURA DEL MAPA ======================
local TEXTURE_PACKS = {
    ["item_slot_3_blue_hollow"] = {
        -- ====================== TEXTURA DEL MAPA ======================
        {ids = {7658055825}, url = "https://raw.githubusercontent.com/jixyuk12nh-maker/Ui/main/texture_pack/item_slot_3_blue_hollow.png"},
    },
    ["c5ce6cb7"] = {
        -- ====================== TEXTURA DEL MAPA ======================
        {ids = {7658055825}, url = "https://raw.githubusercontent.com/jixyuk12nh-maker/Ui/main/texture_pack/c5ce6cb7-b2a6-4fc9-b59b-87a9627c8552.png"},
    },
}
...
TexturePackBox:AddCheckbox("TexturePackEnabled", {
    Text = "Texture Pack",
    Default = texturePackState.Enabled == true,
    Callback = function(Value)
...
TexturePackBox:AddDropdown("TexturePack", {
    Text = "Texture Pack",
    Values = { "None", "item_slot_3_blue_hollow", "c5ce6cb7" },
