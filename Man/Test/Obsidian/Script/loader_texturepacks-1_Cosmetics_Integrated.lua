...
--// Cosmetics system imported from Notes_260923_213350.txt
local CosmeticsWrap = {}
...
CosmeticsWrap.Scene.equipment()
CosmeticsWrap.Scene.selection()
end
...
if #classNames == 0 then
    CosmeticsGroup:AddLabel("코스메틱 데이터를 찾지 못했습니다.")
else
...
ViewerImage = CosmeticsGroup:AddImage("ViewerImage", {
Image = "rbxassetid://0",
Height = 220,
...
CharmViewport.Parent = CosmeticsGroup.Container
...
WrapViewport.Parent = CosmeticsGroup.Container
...
InfoLabel = CosmeticsGroup:AddLabel({ Text = "" })
