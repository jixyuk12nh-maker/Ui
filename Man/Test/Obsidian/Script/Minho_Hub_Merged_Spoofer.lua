...
local function spooferIdentity()
    if SpooferCfg.Name.on then pcall(function() LocalPlayer.Name=tostring(SpooferCfg.Name.val) end) end
    if SpooferCfg.DisplayName.on then pcall(function() LocalPlayer.DisplayName=tostring(SpooferCfg.DisplayName.val) end) end
end
