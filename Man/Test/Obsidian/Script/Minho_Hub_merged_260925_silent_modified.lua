...
local function SecretAttachStart()
    ...
    if SecretAttachRagebot.SilentAim and hookmetamethod and getnamecallmethod then
        local oldNamecall
        oldNamecall = hookmetamethod(game, "__namecall", function(self, ...)
            if not SecretAttachRagebot.Enabled then
            ...
            if method == "Raycast" and self == workspace then
                ...
                if myRoot and typeof(origin) == "Vector3"
                    ...
                    if target and target.Head and target.Head.Parent then
                        local newDir = (target.Head.Position - origin).Unit * direction.Magnitude
        ...
        SecretAttachRagebot.NamecallHook = oldNamecall
    end
...
local function SecretAttachStop()
    ...
    if SecretAttachRagebot.NamecallHook and restorefunction then
