...
local Library
do
    local ok, src = pcall(readfile, "Library-4-Obsidian-UI.lua")
    assert(ok and type(src) == "string", "Minho Hub: Library-4-Obsidian-UI.lua not found")
    Library = assert(loadstring(src))()
end
