...
local MainGroup = MainTab:AddLeftGroupbox("Test")

MainGroup:AddLabel("Obsidian UI Loaded!")

MainGroup:AddButton("Test Button", function()
    Library:Notify({
        Title = "Obsidian",
        Description = "정상적으로 작동합니다.",
        Time = 3,
    })
end)

MainGroup:AddToggle("Test Toggle", {
    Text = "테스트",
    Default = false,
